...
import ape.ui.graphics.modelview.ahl.instantiation.AHLInstArcVisual;
import ape.ui.graphics.modelview.ahl.instantiation.AHLInstPlaceVisual;
import ape.ui.graphics.modelview.ahl.instantiation.AHLInstTransitionVisual;
import ape.ui.graphics.modelview.pt.PTArcVisual;
import ape.ui.graphics.modelview.pt.PTPlaceVisual;
import ape.ui.graphics.modelview.pt.PTTransitionVisual;
...
public class VisualFactory implements Serializable {
  ...
  private PlaceVisual createPlaceVisual(Place p) {
    switch(netType()) {
      ...
      case AHLNet:
        return new AHLPlaceVisual(modelView.getCurrentGraphics(), p);
      case AHLInstantiation:
        return new AHLInstPlaceVisual(modelView.getCurrentGraphics(), p);
      default:
  ...
  private TransitionVisual createTransitionVisual(Transition t) {
    switch(netType()) {
      ...
      case AHLNet:
        return new AHLTransitionVisual(modelView.getCurrentGraphics(), t);
      case AHLInstantiation:
        return new AHLInstTransitionVisual(modelView.getCurrentGraphics(), t);
      default:
  ...
  private ArcVisual createArcVisual(ArcCollection a) {
    ...
    switch(netType()) {
      ...
      case AHLNet:
        return new AHLArcVisual(modelView.getCurrentGraphics(), pv, tv, dir, a);
      case AHLInstantiation:
        return new AHLInstArcVisual(modelView.getCurrentGraphics(), pv, tv, dir, a);
      default:
        throw new UnsupportedOperationException("Transition visual creation not yet implemented for net type " + netType() + ".");
    }
  }
